//package com.birdplanet.core.foundation.util;
//
...
// * @author dwy
// */
//public class IdenticonAvatarGenerator {
//
...
//    }
//    // bottom
//    for (int i = GITHUB_AVATAR_COLS - 1; i > GITHUB_AVATAR_COLS - GITHUB_AVATAR_FRAME_WIDTH - 1;
//        i--) {
//      for (int j = 0; j < GITHUB_AVATAR_COLS; j++) {
//        for (int k = 0; k < channels; k++) {
//          bgrData[i][j][k] = (byte) COLOR_GREY_BGR[k];
...
//    // right
//    for (int i = 0; i < GITHUB_AVATAR_COLS; i++) {
//      for (int j = GITHUB_AVATAR_ROWS - 1; j > GITHUB_AVATAR_ROWS - GITHUB_AVATAR_FRAME_WIDTH - 1;
//          j--) {
//        for (int k = 0; k < channels; k++) {
//          bgrData[i][j][k] = (byte) COLOR_GREY_BGR[k];
//        }
...
//    IdenticonAvatarGenerator githubAvatarGenerator = new IdenticonAvatarGenerator();
//    for (int i = 1; i <= 20; i++) {
