...
public class RedisUtils {
  ...
  /**
   * 指定缓存失效时间 java -Xms512m -Xmx2g -Xss1m -XX:+PrintGCDetails -XX:+HeapDumpOnOutOfMemoryError
   * -server -jar
   *
   * @param key  键
   * @param time 时间(秒)
  ...
  public boolean setMinutes(String key, Object value, int minutes) {
    return this.set(key, value, minutes, TimeUnit.MINUTES);
  }

  public boolean setHours(String key, Object value, int hours) {
    return this.set(key, value, hours, TimeUnit.HOURS);
  }

  public boolean setDays(String key, Object value, int days) {
    return this.set(key, value, days, TimeUnit.DAYS);
  }
  ...
  public boolean set1Year(String key, Object value) {
    return this.set(key, value, 365, TimeUnit.DAYS);
  }
  ...
  public boolean hash_put1Day(String key, Object hashKey, Object hashVal) {
    return this.hash_put(key, hashKey, hashVal, 1, TimeUnit.DAYS);
  }
